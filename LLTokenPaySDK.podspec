#
# Be sure to run `pod lib lint LLTokenPaySDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of LLTokenPaySDK.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'LLTokenPaySDK/Classes/**/*'
  
  # s.resource_bundles = {
  #   'LLTokenPaySDK' => ['LLTokenPaySDK/Assets/*.png']
  # }
