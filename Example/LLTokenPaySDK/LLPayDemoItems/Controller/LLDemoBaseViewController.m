...
- (void)llAlertWithMsg: (NSString *)msg {
    [[[UIAlertView alloc] initWithTitle:@"Ooops!" message:msg delegate:self cancelButtonTitle:@"Okay" otherButtonTitles: nil] show];
}

- (void)refreshOrder {
    [self.tableView field:@"no_order"].text = [NSString stringWithFormat:@"LL%@",[LLPayUtil timeStamp]];
    [[self.tableView field:@"no_order"] cacheText];
